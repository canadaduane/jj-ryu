...
4. 🔴 **Execution test**: `test_execute_merge_calls_retarget`
...
5. 🔴 **Execution test**: `test_execute_merge_stops_on_retarget_failure`
...
3. 🔴 Update `docs/merge.md` (if exists) with user-facing explanation
